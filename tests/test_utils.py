...
class TestFunctions(unittest.TestCase):
    ...
    def test_way_json_file_empty(self, mock_open):
        """Тест: файл пустой."""
    ...
    def test_sum_transaction_usd(self, mock_convert):
